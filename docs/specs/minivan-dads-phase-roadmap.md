...
Companion to `minivan-dads-brain-project-brief.md`. The brief tells Claude Code WHAT to build in Phase 1; this document is the operating plan across phases — build work, CEO work, milestones, and exit criteria. This file should eventually live in HQ (e.g., `hq/charter/roadmap.md`) so the brain can reference it.
